            ...
            <div class="card">
                <div class="card-header">
                    ...
                    @if(auth()->user()->hasPermission('create_roles'))
                        <a class="float-right" href="{{ route('create_department') }}" >
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        @if($result->id==1)
                            <a href="{{ url('edit_department', $result->id) }}"><i class="fa fa-edit text-warning"></i></a> 
                        @else
                        <form action="{{ route('delete_department', $result->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this department?');">
                            @csrf
                            <a href="{{ url('edit_department', $result->id) }}"><i class="fa fa-edit text-warning"></i></a> 
