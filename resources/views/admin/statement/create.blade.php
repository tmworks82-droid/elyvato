            ...
            <div class="container mt-4">
                <div class="card">
                    ...
                    <div class="card-header bg-primary text-white">
                        <h3 class="card-title">Add Gig</h3>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('save.statement-work') }}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="preselected_subservice"
                                value="{{ old('subservice_id', $statement->subservice_id ?? '') }}">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-select form-control" id="service_id" name="service_id" required>
                                        ...
                                        @if (!empty($service) && count($service) > 0)
                                            @foreach ($service as $ser)
                                                <option value="{{ $ser->id }}"
                                                    {{ old('service_id', $statement->service_id ?? '') == $ser->id ? 'selected' : '' }}>
                                                    {{ $ser->name }}
                                                </option>
                                            @endforeach
                                        @endif
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-select form-control" id="subservice_id" name="subservice_id"
                                        required>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" name="title" id="title" placeholder="Title"
                                        class="form-control" value="{{ old('title', $statement->title ?? '') }}" required>
                                </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="estimated_time" name="estimated_time"
                                        ...
                                        value="{{ old('estimated_time', $statement->estimated_time ?? '') }}" required>
                                </div>
                                ...
                                <div class="mb-3 file-input-group col-md-4" id="video_input" style="display: none;">
                                    ...
                                    <div class="input-group" id="video_input_group">
                                        <input type="text" class="form-control" placeholder="Past here video link"
                                            name="video[]" accept="video/*">
                                        <button type="button" class="btn btn-sm btn-success"
                                            id="add_video_input">+</button>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="featured" id="no"
                                            value="no"
                                            {{ isset($statement) && $statement->featured == 'no' ? 'checked' : '' }}
                                            checked>
                                ...
                                <div class="mb-3 col-md-4" id="subscription_time_wrapper" style="display: none;">
                                    ...
                                    <select class="form-select form-control" id="subscription_time"
                                        name="subscription_time">
                                        <option value="">Subs Time</option>
                                        <option value="monthly"
                                            {{ isset($statement) && $statement->subscription_time == 'monthly' ? 'selected' : '' }}>
                                            Monthly</option>
                                        <option value="weekly"
                                            {{ isset($statement) && $statement->subscription_time == 'weekly' ? 'selected' : '' }}>
                                            Weekly</option>
                                        <option value="biweekly"
                                            {{ isset($statement) && $statement->subscription_time == 'biweekly' ? 'selected' : '' }}>
                                            Biweekly</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header bg-primary">Add Gig Pricing </div>
                                        <div class="row card-body">

                                            <!-- Price Range -->
                                            <div class="mb-3 col-md-4">
                                                <label for="min_price" class="form-label">INR Min Price</label>
                                                <input type="number" class="form-control" id="min_price"
                                                    name="min_price" step="0.01" placeholder="Enter min price"
                                                    value="{{ old('min_price', $statement->min_price ?? '') }}">
                                            </div>

                                            <div class="mb-3 col-md-4">
                                                <label for="max_price" class="form-label">INR Max Price</label>
                                                <input type="number" class="form-control" id="max_price"
                                                    name="max_price" placeholder="Enter max price" step="0.01"
                                                    value="{{ old('max_price', $statement->max_price ?? '') }}">
                                            </div>

                                            <div class="mb-3 col-md-4">
                                                <label for="max_price" class="form-label">INR Offer Price</label>
                                                <input type="number" class="form-control" id="offer_price"
                                                    name="offer_price" placeholder="Enter max price" step="0.01"
                                                    value="{{ old('offer_price', $statement->offer_price ?? '') }}">
                                            </div>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select class="form-control" id="country">
                                                    ...
                                                    @foreach ($country as $co)
                                                        <option value="{{ $co->id }}"
                                                            data-name="{{ $co->country_name }}">{{ $co->country_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>

                                     <!-- Container where the dynamic fields will be added -->
                                            <div id="country-fields-wrapper" class="col-12">
                                          @if(!empty($statement->currencies) && count($statement->currencies)>0)

                                              @foreach($statement->currencies as $currency)
                                              
                                                <div class="row country-group" data-country-id="{{$currency->country_id}}">
                                                    <input type="hidden" name="countries[]" value="{{$currency->country_id}}">

                                                    <div class="mb-3 col-md-3">
                                                        <label class="form-label">Country</label>
                                                        <input type="text" class="form-control" value="{{$currency->currency_name}}"
                                                            readonly>
                                                    </div>

                                                    <div class="mb-3 col-md-3">
                                                        <label class="form-label">Min Price</label>
                                                        <input type="number" class="form-control" name="usd_min_price[]"
                                                            step="0.01" value="{{$currency->min_price}}" placeholder="Enter min price">
                                                    </div>

                                                    <div class="mb-3 col-md-3">
                                                        <label class="form-label">Max Price</label>
                                                        <input type="number" class="form-control" name="usd_max_price[]"
                                                            step="0.01" value="{{$currency->price}}" placeholder="Enter max price">
                                                    </div>

                                                    <div class="mb-3 col-md-2">
                                                        <label class="form-label"> Offer Price</label>
                                                        <input type="number" class="form-control"
                                                            name="use_offer_price[]" step="0.01" value="{{$currency->offer_price}}"
                                                            placeholder="Enter offer price">
                                                    </div>

                                                    <div class="mb-3 col-md-1 d-flex align-items-end">
                                                        <button type="button"
                                                            class="btn btn-danger btn-sm remove-country">Remove</button>
                                                    </div>
                                                </div>
                                                @endforeach
                                                @endif
                            ...
                            <button type="submit" name="button" value="Save Statement of works"
                                class="btn btn-success mt-3">Save Statement of Work</button>
                        </form>
...
@push('scripts')
  ...
  `;
    ...
    <script>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $.each(response, function(key, subservice) {
                                let selected = (selectedSubId && selectedSubId == subservice
                                    .id) ? 'selected' : '';
                                subserviceDropdown.append('<option value="' + subservice.id +
                                    '" ' + selected + '>' + subservice.name + '</option>');
                            });
                        }
                    });
                }
        ...
        // here is prices fields 

        $(document).ready(function() {
            $('#country').change(function() {
                var selected = $(this).val();
                var countryName = $('#country option:selected').data('name');

                if (selected) {
                    // Check if the country has already been added
                    if ($('#country-fields-wrapper').find('[data-country-id="' + selected + '"]').length >
                        0) {
                    ...
                    var html = `
                <div class="row country-group" data-country-id="${selected}">
                    <input type="hidden" name="countries[]" value="${selected}">
                    ...
                    <div class="mb-3 col-md-3">
                        <label class="form-label">Min Price</label>
                        <input type="number" class="form-control" name="usd_min_price[]" step="0.01" placeholder="Enter min price">
                    </div>

                    <div class="mb-3 col-md-3">
                        <label class="form-label">Max Price</label>
                        <input type="number" class="form-control" name="usd_max_price[]" step="0.01" placeholder="Enter max price">
                    </div>

                    <div class="mb-3 col-md-2">
                        <label class="form-label"> Offer Price</label>
                        <input type="number" class="form-control" name="use_offer_price[]" step="0.01" placeholder="Enter offer price">
                    </div>
                ...
                `;
                    ...
                    $('#country-fields-wrapper').append(html);
                    $(this).val(''); // Reset selection
                }
            });

            // Remove button functionality
            $('#country-fields-wrapper').on('click', '.remove-country', function() {
