...
<head>
  ...
  <title>Your Instant Hire Call Is Locked In</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <h1>Your Instant Hire Call Is Locked In</h1>

    <!-- Main Content -->
    <h2>Let’s Talk Strategy</h2>
    <h3>Your Instant Hire call has been scheduled. Our team looks forward to understanding your goals and exploring solutions together.</h3>

    <div class="booking-details">
      <h3>Your Instant Summary</h3>
    
      <p><strong>Status:</strong> {{ ucfirst($booking->status ?? 'pending') }}</p>
      <p><strong>Total Amount:</strong> ₹{{ number_format($booking->initial_paid_amount ?? 0, 2) }}</p>
      <p><strong>Requested On:</strong> {{ \Carbon\Carbon::parse($booking->created_at)->format('d M Y, h:i A') }}</p>
    </div>

    <div class="next-steps">
      <p><strong>What Happens Next?</strong> Our team is reviewing the details and availability. We will connect with you very soon.</p>
    </div>
