...
<body>
  <div class="container">
    ...
    <h2>🎉 You're Back! Elyvato Subscription Activated</h2>
    <p>Your subscription has been successfully activated. You now have full access to all premium features on <a href="https://elyvato.com" target="_blank">elyvato.com</a>.</p>

    <p><strong>Status:</strong> Active</p>
    <p><strong>Plan:</strong> {{ $time ?? 'N/A' }}</p>
    <p><strong>Activated On:</strong> {{ \Carbon\Carbon::parse($date)->format('d M Y, h:i A') }}</p>
    ...
    <div class="footer">
      ...
      <p><a href="#" style="color:#000000;">Unsubscribe</a> | <a href="{{ url('/dashboard') }}" style="color:#020202;">My Account</a></p>
