        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 pe-lg-5 mb-4 mb-lg-0">
                    <h1 class="mb-2 fw-bold">Post Your Custom Gig</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <input type="hidden" name="sow_id" value="{{ $sow_id }}">
                        </div>
                        </div>
                        ...
                        <input type="hidden" name="call_boking_price" id="call_boking_price" value="9">
                         ...
                         <div class="form-floating mb-3">
                            ...
                            <label for="role_designation">Service Category</label>
                        </div>

                        <div class="form-floating mb-3">
                            <select class="form-select focus-shadow-none" id="subservice" name="subservice">
                        ...
                        <button type="submit" value="Post Custom Gig" class="btn btn-main custom-gig">Post Custom Gig</button>
                    </form>
                </div>
                <div class="col-lg-4">
...
function getNextInterval(date, interval) {
    ...
    if (container.innerHTML === "") {
        ...
        // here start booking 
        $('#custom_booking').on('submit', function (e) {
            e.preventDefault();
        ...
        function createRazorpayOrderAndPay(sow_id, price, formData) {
            // alert(price);
                ...
                success: function (response) {
                    ...
                    if (response.success == true) {
                        Swal.fire("Success", response.message, "success").then(() => {
                            window.location.href = "{{ url('/booking-details') }}/"+response.booking_id;
                        });
                    } else {
