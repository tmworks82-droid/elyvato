        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 pe-lg-5 mb-4 mb-lg-0">
                    ...
                    <p class="mb-3 mb-md-4">Your project, your choice – explore skilled professionals ready to work with you.</p>
                    
							<div class="mb-4">
                        	    <span class="btn-accent p-2 mb-3" style=" border-radius: 6px;"> Book your instant call for just ₹9 — fully adjusted in your project cost. </span>
                            </div>
