        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                @if (auth()->user()->hasPermission('task_list'))
                    <li class="nav-item {{ request()->is('task-list') ? 'menu-open' : '' }}">
                        <a href="{{ route('task.list') }}"
                            class="nav-link {{ request()->is('task-list') || request()->is('task-list') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Task List
                            </p>
                ...
                @if (auth()->user()->hasPermission('projects'))
                    <li
                        class="nav-item {{ request()->is('projects') || request()->is('booking') || request()->is('payments') || request()->is('projects-details') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->is('projects') || request()->is('booking/*') || request()->is('booking-calls') || request()->is('booking-calls/*') || request()->is('payments/*') || request()->is('projects-details') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('booking') }}"
                                    class="nav-link {{ request()->is('booking') || request()->is('booking-calls') || request()->is('booking-calls/*') ? 'active' : '' }}">
                ...
                @if (auth()->user()->hasPermission('manage_users'))
                    <li
                        class="nav-item {{ request()->is('admin_user') ||
                        ...
                        request()->is('create-hire-talent')
                            ...
                            : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->is('admin_user') ||
                            request()->is('admin_user/*') ||
                            request()->is('users') ||
                            request()->is('users/*') ||
                            request()->is('role') ||
                    ...
                    <p>Users</p>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('permission.index') }}"
                                    class="nav-link {{ request()->is('permission') || request()->is('permission/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Permission</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('permission_role.index') }}"
                                    class="nav-link {{ request()->is('permission_role') || request()->is('permission_role/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Role Permission</p>
                                </a>
                            </li>
                ...
                @if (auth()->user()->hasPermission('services'))
                    <li
                        class="nav-item {{ request()->is('service') || request()->is('service/*') || request()->is('create-sub-services/*') || request()->is('subServices') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->is('service') || request()->is('service/*') || request()->is('create-sub-services') || request()->is('subServices') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-cog"></i>
                            <p>
                                Services Setting
                                <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('subServices') }}"
                                    class="nav-link {{ request()->is('subServices') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sub-Service</p>
                                </a>
                            </li>
                ...
                @if (auth()->user()->hasPermission('setting'))
                    <li
                        class="nav-item {{ request()->is('initial-payment-setting') ||
                        request()->is('statement/*') ||
                        request()->is('statement') ||
                        request()->is('gst-rate/*') ||
                        request()->is('gst-rate') ||
                        ...
                        <a href="#"
                            class="nav-link {{ request()->is('initial-payment-setting') ||
                            request()->is('statement') ||
                            request()->is('gst-rate/*') ||
                            request()->is('create-statement') ||
                            request()->is('case-study/*') ||
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @if (auth()->user()->hasPermission('show_initial_payment_setting'))
                                <li class="nav-item">
                                    <a href="{{ url('initial-payment-setting') }}"
                                        class="nav-link {{ request()->is('initial-payment-setting') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @if (auth()->user()->hasPermission('statement'))
                                <li class="nav-item">
                                    <a href="{{ url('statement') }}"
                                        class="nav-link {{ request()->is('statement') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            @if (auth()->user()->hasPermission('show_gst_rate'))
                                <li class="nav-item">
                                    <a href="{{ url('gst-rate') }}"
                                        class="nav-link {{ request()->is('gst-rate') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>GST Rates</p>
                                    </a>
                                </li>
                            ...
                            @if (auth()->user()->hasPermission('faq'))
                                <li class="nav-item">
                                    <a href="{{ url('faq') }}"
                                        class="nav-link {{ request()->is('faq') || request()->is('create-faq') || request()->is('edit-faq/*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Faq</p>
                                    </a>
                                </li>
                            ...
                            @if (auth()->user()->hasPermission('case-study'))
                                <li class="nav-item">
                                    <a href="{{ url('case-study') }}"
                                        class="nav-link {{ request()->is('case-study') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Case Study</p>
                                    </a>
                                </li>
                            ...
                            @if (auth()->user()->hasPermission('hire_talent'))
                                <li class="nav-item">
                                    <a href="{{ route('admin.hire.talent') }}"
                                        class="nav-link {{ request()->is('hire-talent') || request()->is('create-hire-talent') || request()->is('edit-hire-talent/*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Hire Talent</p>
                                    </a>
                                </li>
          ...
          @endif --}}
                ...
                @if (auth()->user()->hasPermission('manage_location'))
                    <li
                        class="nav-item {{ request()->is('state') || request()->is('state/*') || request()->is('city/*') || request()->is('city') || request()->is('country') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->is('state') || request()->is('state/*') || request()->is('city/*') || request()->is('city') || request()->is('country') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-cog"></i>
                            <p>
                                Location
                                <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('state.index') }}"
                                    class="nav-link {{ request()->is('state') || request()->is('state/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>State</p>
                                </a>
                            </li>
